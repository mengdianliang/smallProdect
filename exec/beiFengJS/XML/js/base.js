...
Number.prototype.inter=function (a,b) {//��������Ƿ�������֮��
...
if (document.implementation && document.implementation.createDocument) {
	//W3C
	Base.getXMLDOM=function () {//��ȡһ��XMLDOM����
...
args {
	...
	success Function
	data {key:value}
	cache Boolean true��ʾ����,Ĭ��ֵΪfalse
}
*/
...
Base.swapNode =function (a,b) {
	//parentNode.insertBefore(Ҫ����Ľڵ�,ԭ���Ľڵ�)
...
//invoke(fn,obj,1,2,3) ִ��fn����������obj���fn�ڲ���thisָ��Ķ���
//1,2,3....���Ǵ���fn�Ĳ���
...
function addEvent(obj,evt,fn) {
	...
	if (typeof obj["on"+evt]=="function") {
		//alert(obj["on"+evt]);//����һ��ִ�е�ʱ��obj["on"+evt] ����handler
...
function fixEvt(evt,o) {
	...
	//IE��Opera��offsetX,offsetYû�н��߿����֮��
	if (o!=window && o.nodeType) {//Ҫ����һ��DOM����
